	...
	return (
		...
		>
			...
			<motion.div
				...
				style={{ opacity }}
			>
				<div className="max-w-4xl mx-auto text-center space-x-2">
					<motion.div
					...
					>
						<div className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 animate-pulse" />
						<div className="relative px-6 py-3 bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl flex items-center gap-3">
							<motion.div
								animate={{
									scale: [1, 1.2, 1],
									rotate: [0, 10, -10, 0],
							...
							<div className="text-left">
								<p className="text-sm font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-clip-text text-transparent">
									New Year Special Offer!
								</p>
								<p className="text-xs text-muted-foreground">
									Free software development & maintenance for
									a limited time.
								</p>
							</div>
							<motion.div
