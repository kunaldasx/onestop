...
export function WhatsAppButton({
	...
	return (
		<motion.a
			...
			className="fixed bottom-7 right-7 md:bottom-6 md:right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg cursor-pointer"
