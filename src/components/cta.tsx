					...
					<div className="relative z-10 p-12 md:p-20">
						<div className="text-center max-w-3xl mx-auto">
							...
							>
								...
								powerful digital solutions that drive growth and
								innovation.
							</motion.p>
							...
							>
								...
								>
									<Button
										...
										className="px-8 py-4 text-lg font-medium gap-2 group bg-white text-primary hover:bg-white/90 relative overflow-hidden"
								...
								>
									<Button
										...
										className="px-8 py-4 text-lg font-medium border-white/30 text-primary-foreground hover:bg-white/10 bg-transparent backdrop-blur-sm"
