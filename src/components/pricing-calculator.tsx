...
const complexityMultipliers = [
	...
	},
	{
		label: "Advanced",
		value: 2.5,
		description: "Complex project with integrations",
	},
	{
		label: "Enterprise",
		value: 4,
		description: "Large-scale, mission-critical solution",
	},
];
...
export function PricingCalculator() {
	...
	const estimatedPrice = useMemo(() => {
		...
		const timelineMultiplier =
			timeline[0] <= 1 ? 1.5 : timeline[0] <= 2 ? 1.25 : 1;
		const supportCost = includeSupport ? 500 * timeline[0] : 0;

		return Math.round(
			baseTotal * complexityMultiplier * timelineMultiplier + supportCost
		);
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-muted-foreground text-lg leading-relaxed">
						Get an instant estimate for your project. Select the
						services you need and customize the options to see your
						personalized quote.
					</p>
				</motion.div>
						...
						<Card className="p-6 border-border/50">
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-sm text-muted-foreground mt-1">
										24/7 dedicated support and faster
										response times
									</p>
								</div>
								<Switch
