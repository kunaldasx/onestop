        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-foreground mt-4 mb-6">
              Your <span className="gradient-text">OneStop</span> Digital
              Partner
            </h1>
            <p className="text-muted-foreground text-lg leading-relaxed">
              We're a team of passionate developers, designers, and strategists
              dedicated to delivering comprehensive digital solutions - from SEO
              and lead generation to full-scale software development.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed mb-6 text-lg">
                  ...
                  complex technical solutions and real-world business needs.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-8">
                  Founded with a vision to make premium digital services
                  accessible to businesses of all sizes, we've grown into a
                  full-service agency that partners with companies worldwide to
