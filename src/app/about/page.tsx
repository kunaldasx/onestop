...
const stats = [
  { value: 50, suffix: "+", label: "Happy Clients", gradient: "from-blue-500 to-purple-500" },
  { value: 200, suffix: "+", label: "Projects Completed", gradient: "from-green-500 to-emerald-500" },
  { value: 15, suffix: "+", label: "Team Members", gradient: "from-orange-500 to-yellow-500" },
  { value: 5, suffix: "+", label: "Years Experience", gradient: "from-pink-500 to-rose-500" },
];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                <div>
                  ...
                  <motion.p 
                    ...
                    viewport={{ once: true }}
                  >
                    At NexaTech, we believe technology should empower businesses,
